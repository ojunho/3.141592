...
class SlideWindow:
    ...
    def slidewindow(self, img, flag):
        ...
        # between distance of two slidingwindows
        between_distance = 0.5
        ...
        # print("good_left", len(good_left_inds))
        # print("good_right", len(good_right_inds))	
        ...
        if line_flag != 3:
		    ...
		    #왼쪽 차선 우선
                if line_flag == 1: 
                    ...
                    if win_y_low >= 330 and win_y_low < 340:
